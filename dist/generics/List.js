...
function List(_a) {
    ...
    return react_1["default"].createElement(as, __assign({ className: (0, clsx_1["default"])('jpk-list', className) }, restProps), children);
}
exports.List = List;
function ListItem(_a) {
    ...
    return react_1["default"].createElement(as, __assign({ className: (0, clsx_1["default"])('jpk-list__item', className) }, restProps), children);
}
